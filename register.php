...
if (isset($_POST['form_sent']))
{
	...
	if (empty($errors))
	{
		...
		$getLastIdUser = sqlArray(sqlQuery("select max(id) from users"));
		$maxIdUser = $getLastIdUser['max(id)'];
		...
		$Avatar->Save('img/avatars/' . $maxIdUser . '.png', 60);
			...
			<div class="inform">
				<fieldset>
					...
					<div class="infldset">
						...
						<br /><input type='hidden' value='7' id="time_zone" name="timezone">
